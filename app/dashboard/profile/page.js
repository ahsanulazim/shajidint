    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-5 items-center bg-white p-8 rounded-md shadow-sm sm:max-w-fit">
        ...
        <fieldset className="fieldset">
          ...
          <p className="text-md sm:text-lg">Ahsanul Azim Plabon</p>
          <label className="label">Email</label>
          <p className="text-md sm:text-lg">ahsanulazim6@gmail.com</p>
          <label className="label">Phone</label>
          <p className="text-md sm:text-lg">01612345678</p>
          <label className="label">Designation</label>
          <p className="text-md sm:text-lg">Founder & CEO</p>
          ...
          <button className="btn rounded-md btn-neutral mt-5">
            <FaPenToSquare />
            Edit
          </button>
        </fieldset>
