    ...
    return (
        <>
            <div className="grid grid-cols-1 grid-rows-14 sm:grid-cols-2 sm:grid-rows-8 lg:grid-cols-3 lg:grid-rows-5 2xl:grid-cols-4 2xl:grid-rows-4 text-left gap-5 mt-10">
                ...
                <div className="p-5 rounded-md bg-neutral-900 border border-neutral-700 order-2 sm:order-5 2xl:order-2">
                ...
                <div className="p-5 rounded-md bg-neutral-900 border border-neutral-700 order-4 sm:order-2 2xl:order-3">
                ...
                <div className="p-5 rounded-md bg-neutral-900 border border-neutral-700 row-span-2 order-5 sm:order-4">
                ...
                <div className="p-5 rounded-md bg-neutral-900 border border-neutral-700 order-6 sm:order-8 lg:order-6">
                ...
                <div className="p-5 rounded-md bg-neutral-900 border border-neutral-700 sm:col-span-2 row-span-2 order-1 2xl:order-5">
                ...
                <div className="p-5 rounded-md bg-neutral-900 border border-neutral-700 sm:col-span-2 order-8 sm:order-6 lg:order-8">
                ...
                <div className="p-5 rounded-md bg-neutral-900 border border-neutral-700 order-9">
                ...
                <div className="p-5 rounded-md bg-neutral-900 border border-neutral-700 row-span-2 lg:row-span-1 2xl:row-span-2 order-10 sm:order-7">
